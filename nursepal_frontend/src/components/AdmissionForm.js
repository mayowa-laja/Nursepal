...
export const AdmissionForm = ({ handleAdmissionSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage('Patient admitted successfuly');
            setFormData({
                name: '',
                age: '',
                dateOfBirth: '',
    ...
    return (
        <div className="container-fluid">
            <button className="btn btn-secondary" onClick={toggleForm}>{isExpanded ? 'Collapse Admission Form' : 'Admit a Patient'}</button>
